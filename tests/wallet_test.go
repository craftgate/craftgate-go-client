...
func TestWallet_RefundWalletTransactionToCard(t *testing.T) {
    request := adapter.RefundWalletTransactionToCardRequest{RefundPrice: 10}
    res, err := walletClient.Wallet.RefundWalletTransactionToCard(context.Background(), 1, request)
    _, _ = spew.Printf("%#v\n", res)
...
func TestWallet_RetrieveRefundWalletTransactionsToCard(t *testing.T) {
    res, err := walletClient.Wallet.RetrieveRefundWalletTransactionsToCard(context.Background(), 1)
    _, _ = spew.Printf("%#v\n", res)
